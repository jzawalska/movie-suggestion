(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('movies',{
	        url:'/movies',
	        templateUrl: viewsPrefix + 'movies.html',
	        controller:'MoviekListController'
	    }).state('viewMovie',{
	       url:'/movies/:id/view',
	       templateUrl: viewsPrefix + 'movie-view.html',
	       controller:'MovieViewController'
	    }).state('newMovie',{
	        url:'/movies/new',
	        templateUrl: viewsPrefix + 'movie-add.html',
	        controller:'MovieCreateController'
	    }).state('editMovie',{
	        url:'/movies/:id/edit',
	        templateUrl: viewsPrefix + 'movie-edit.html',
